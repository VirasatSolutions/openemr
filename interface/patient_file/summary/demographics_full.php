     ...
     <div class="tab <?php echo $i == 1 ? 'current': '' ?>" style='height:auto;width:auto'>     <!---display icky, fix to auto-->
      ...
      <div class="row">
        ...
        <table border="0">
            ...
            <tr>
                <td><label class='required'><?php echo xlt('Accept Assignment'); ?></label></td>
                <td class=required>:</td>
                <td>
				...
				<span class='claim_number'>
					<td colspan="2"><label class='required'><?php echo xlt('Claim Number :'); ?><input type='text' class='form-control' size='20' name='i<?php echo attr($i); ?>claim_number' value='<?php echo attr($result3["claim_number"]); ?>' /></label></td>
				</span>
            </tr>
      <tr>
