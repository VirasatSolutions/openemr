                        ...
                        <table border="0">
                            ...
                            <tr>
                                ...
                                <td valign=top>
									...
									<span class='claim_number' style="display: none;">
									<span class=bold><?php echo xlt('Claim Number'); ?>:
									<input type='text' class='form-control' size='20' name='i<?php echo attr($i); ?>claim_number' value='<?php echo attr($result3["claim_number"]); ?>' />
									</span></span>
                                </td>
                            </tr>
                        </table>
...
$(function () {
	$("#form_usertype").change(function() {
		if($(this).val() == 2){
			$('span.claim_number').show();
		}else{
			$('span.claim_number').hide();
		}
	});
