...
$authorization       = isset($_POST['authorization']) ? 1 : 0;
$authorization_code  = isset($_POST['authorization_code']) ? $_POST['authorization_code'] : '';
$encounter_no        = isset($_POST['encounter_no']) ? $_POST['encounter_no'] : '';
